import discord, asyncio, random, aiohttp
...
class nitroButtons(discord.ui.View):
  ...
  async def nitroButton(self, button: discord.ui.Button, interaction: discord.Interaction):
    ...
    await interaction.followup(content = "Prepare to get rickrolled...(it's a good song anyway)")
    await asyncio.sleep(2)

    await interaction.followup(content = "https://i.imgur.com/NQinKJB.gif")
