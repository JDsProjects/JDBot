...
class Test(commands.Cog):
    ...
    async def jokeapi(self, ctx):
        jokeapi_grab = await self.client.session.get(
    ...
    @commands.command(
        brief="a command that can scan urls(work in progress), and files",
        help="please don't upload anything secret or send any secret url thank you :D",
    )
