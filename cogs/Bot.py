...
class Bot(commands.Cog):
  ...
  async def promises(self,ctx):
    ...
    embed.add_field(name="6.5.",value="This is a temp command, which is stored no where else, and we also delete the embed when done :D. If you have a problem with this contact me.")
