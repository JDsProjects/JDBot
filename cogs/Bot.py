...
class Bot(commands.Cog):
    ...
    async def promise(self, ctx):
        embed = discord.Embed(
            title="Promises we will follow:", color=random.randint(0, 16777215)
        )
        embed.add_field(
            name="Rule 1:",
        ...
        embed.add_field(
            name="Rule 5:",
            value="we also made sure our code is open source so you can see what it does.",
        )
        embed.add_field(
            name="Rule 6:",
    ...
    async def promises(self, ctx):
        embed = discord.Embed(
            title="Privacy Policies", color=random.randint(0, 16777215)
        )
        embed.add_field(
            name="1:",
        ...
        embed.add_field(
            name="2:",
            value="We will store any errors(which may go back to you, but this is console only",
        )
        embed.add_field(
            name="3",
            value="we will only store user ids(in the future for balance commands and economy commands",
        )
        ...
        embed.add_field(
            name="Final",
            value="There should be no more except the sus list(list of ids I put together by hand of people who probaly shouldn't hang out with)",
        )
        embed.add_field(
            name="Who Gets this info:",
            value="Only us, and our DB company MongoDB(but they are unlikely to use our data. Sus users do show up if they exist in the same guild though and the reason why.",
        )
        embed.add_field(
            name="More Info:", value="Contact me at JDJG Inc. Official#3493"
        )
        await ctx.send(embed=embed)
