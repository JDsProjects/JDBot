...
class DevTools(commands.Cog):
    ...
    async def rtfm_query_autocomplete(self, interaction: discord.Interaction, current: str) -> list[Choice]:
        ...
        all_choices = [Choice(name=result.name, value=result.url.rstrip(url)) for result in unfiltered_results]
        ...
        results = [Choice(name=result.name, value=result.url.rstrip(url)) for result in filtered_results]
